...
private:
	...
	DEFINE_PARAMETERS(
		(ParamFloat<px4::params::YAW_GAIN_DEFAULT>) _param_yaw_gain_default,
		(ParamFloat<px4::params::YAW_RATE_MAX>) _param_yaw_rate_max,
		(ParamFloat<px4::params::YAW_DAMPER_GAIN>) _param_yaw_damper_gain,
		...
		(ParamFloat<px4::params::SL_DB0>) _param_sl_db0,
		(ParamFloat<px4::params::SL_DB9>) _param_sl_db9,
		(ParamFloat<px4::params::SL_DB8>) _param_sl_db8,
		(ParamFloat<px4::params::SL_DB7>) _param_sl_db7,
		(ParamFloat<px4::params::SL_DB6>) _param_sl_db6,
		(ParamFloat<px4::params::SL_DB5>) _param_sl_db5,
		(ParamFloat<px4::params::SL_DB4>) _param_sl_db4,
		(ParamFloat<px4::params::SL_DB3>) _param_sl_db3,
		(ParamFloat<px4::params::SL_DB2>) _param_sl_db2,
		(ParamFloat<px4::params::SL_DB1>) _param_sl_db1,
